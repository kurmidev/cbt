...
class BaseQuery extends \yii\db\ActiveQuery {
    ...
    public function active() {
        return $this->andWhere([$this->tableAlias . 'status' => \common\ebl\Constants::STATUS_ACTIVE]);
    }

    public function inActive() {
        return $this->andWhere([$this->tableAlias . 'status' => \common\ebl\Constants::STATUS_INACTIVE]);
    }
