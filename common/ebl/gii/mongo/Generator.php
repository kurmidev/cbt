...
namespace common\ebl\gii\mongo;
...
class Generator extends \yii\gii\Generator {
    ...
    public $modelClass;
    public $baseClass = 'components\models\BaseMongoModel';
    public $generateQuery = true;
    public $queryNs = 'app\models';
    public $queryClass;
    public $queryBaseClass = 'components\models\BaseMongoQuery';
    ...
    public function rules() {
        return array_merge(parent::rules(), [
            ...
            [['modelClass', 'queryClass'], 'validateModelClass', 'skipOnEmpty' => false],
            [['baseClass'], 'validateClass', 'params' => ['extends' => ActiveRecord::className()]],
            [['queryBaseClass'], 'validateClass', 'params' => ['extends' => \yii\mongodb\ActiveQuery::className()]],
            [['enableI18N'], 'boolean'],
    ...
    public function stickyAttributes() {
        return array_merge(parent::stickyAttributes(), ['ns', 'db', 'baseClass', 'queryNs', 'queryBaseClass']);
    }
    ...
    public function generate() {
        ...
        if ($queryClassName) {
            ...
            $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $queryClassName . '.php', $this->render('query.php', $params)
            );
        }
        return $files;
    }
    ...
    protected function generateQueryClassName($modelClassName) {
        ...
        if (empty($queryClassName) || strpos($queryClassName, '*') !== false) {
