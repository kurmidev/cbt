                    ...
                    <div class="row">
                            ...
                            <div class="well">
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li><strong>Bill Date:</strong> 
                                        <?= date("d-m-y", strtotime($model->start_date)) ?> to 
                        ...
                        <div class=" mt-2 col-lg-6" style="text-align: right">
                            <ul class="list-unstyled">
                                ...
                                <li><?= $operator->name ?></li>
                                <li><?= implode(",<br>", explode(",", $operator->address)) ?></li>
                            </ul>
                        </div>
                            ...
                            <div class="invoice-items">
                                <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <td><?= $model->opening_amount ?></td>
                                        <td><?= $model->sub_amount + $model->sub_amount_tax ?></td>
                                        <td><?= $model->credit_charges_nt ?></td>
                                        <td><?= $model->debit_charges_nt ?></td>
                                        <td><?= $model->payment ?></td>
                                        <td><?= $model->closing_amount ?></td>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><?= abs($model->plan_charges['amount']) ?></td>
                                            </tr>
                                            <tr>
                                                <td>Debit Charges</td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center"><?= abs($model->sub_amount_tax) ?></th>
                                            </tr>
                                            <tr>
                                                <th class="text-right">Total Current Charges:</th>
                                                <th class="text-center"><?= abs($model->sub_amount_tax + $model->sub_amount) ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
