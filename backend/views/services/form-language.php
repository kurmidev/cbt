...
$this->title = ($model->isNewRecord) ? 'Add new Language' : 'Update Language ' . $model->name . ' details.';
$this->params['breadcrumbs'][] = ['label' => 'Language', 'url' => ['area']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="card bd-0 shadow-base widget-14 ht-100p">
    <div class="card-body">
        <?php $form = ActiveForm::begin(['id' => 'form-language', 'options' => ['enctype' => 'mutipart/form-data', 'class' => 'form-horizontal form-bordered']]); ?>
