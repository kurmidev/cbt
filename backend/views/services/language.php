...
$this->title = 'Language';
$this->params['links'] = [
    ['title' => 'Add New Language', 'url' => \Yii::$app->urlManager->createUrl('services/add-language'), 'class' => 'fa fa-plus'],
];
    ...
    'columns' => [
        ...
        ['label' => 'Action',
            'content' => function ($data) {
                return Html::a(Html::tag('span', '', ['class' => 'fa fa-edit']), \Yii::$app->urlManager->createUrl(['services/update-language', 'id' => $data['id']]), ['title' => 'Update ' . $data['name'], 'class' => 'btn btn-primary-alt']);
            }
        ]
    ],
]);
