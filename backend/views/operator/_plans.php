...
<div class="card">
    <div class="row pd-10 mg-10">
        <div class="col-8 col-md-8 col-lg-8 col-sm-6">    
            <strong>Alloted Plan Lists</strong>
        </div>
        <div class="col-4 col-md-4 col-lg-4 col-sm-6">    
            <?=
            Html::a('CHANGE MRP', \Yii::$app->urlManager->createUrl(["operator/add-mrp", 'id' => $id]), ['class' => 'btn btn-outline-teal pd-10 mg-10  pull-right', 'title' => "Add MRP"])
            ?>
        </div>
    </div>

    <?php Pjax::begin(['id' => 'assigned-plan-list']); ?>
