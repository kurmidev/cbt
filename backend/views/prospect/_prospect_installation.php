...
<div class="card">
    <div class="card-header">Installation Process</div>
    <div class="card-body">
        <div class="row">
            <div class="col-sm-3">
                <?= $form->field($model, 'verified_by', ['options' => ['class' => 'form-group']])->begin() ?>
                <?= Html::label('Done By', ['class' => 'control-label']); ?>
                <?= Html::activeDropDownList($model, 'verified_by', $list, ['class' => 'form-control', 'prompt' => 'Select one', 'value' => $model->assigned_engg]) ?>
            ...
            <div class="col-sm-3">
                ...
                <?= Html::label('Done On', ['class' => 'control-label']); ?>
