...
$this->title = 'Area';
$this->params['links'] = [
    ['title' => 'Add New Area', 'url' => \Yii::$app->urlManager->createUrl('location/add-area'), 'class' => 'fa fa-plus'],
];
    ...
    'columns' => [
        ...
        ['label' => 'Action',
            'content' => function ($data) {
                return Html::a(Html::tag('span', '', ['class' => 'fa fa-edit']), \Yii::$app->urlManager->createUrl(['location/update-area', 'id' => $data['id']]), ['title' => 'Update ' . $data['name'], 'class' => 'btn btn-primary-alt']);
            }
        ]
    ],
]);
