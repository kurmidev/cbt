...
$this->title = 'Road';
$this->params['links'] = [
    ['title' => 'Add New Road', 'url' => \Yii::$app->urlManager->createUrl('location/add-road'), 'class' => 'fa fa-plus'],
];
    ...
    'columns' => [
        ...
        ['label' => 'Action',
            'content' => function ($data) {
                return Html::a(Html::tag('span', '', ['class' => 'fa fa-edit']), \Yii::$app->urlManager->createUrl(['location/update-road', 'id' => $data['id']]), ['title' => 'Update ' . $data['name'], 'class' => 'btn btn-primary-alt']);
            }
        ]
    ],
]);
