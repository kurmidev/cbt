...
$this->title = empty($model->id) ? 'Add new NAS' : 'Update NAS ' . $model->name . ' details.';
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-6">
                ...
                <?= Html::activeDropDownList($model, 'type', C::LABEL_NAS, ['class' => 'form-control', 'prompt' => "Select options"]) ?>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-6">
                ...
                <?= Html::activeLabel($model, 'plugin_url', ['class' => 'control-label',"label"=>"NAS IP Address"]); ?>
