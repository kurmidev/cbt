...
<div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <?= Html::activeTextInput($model, 'category_id', ['class' => 'form-control ', "readonly" => true, "value" => $complaint->category->name]) ?>
            ...
            <div class="card-footer mg-t-auto">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12 col-sm-offset-12 text-center">
                        <?= Html::submitButton("Ticket", ['class' => 'btn btn-primary']) ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 col-sm-6 col-xs-12">
        <?= $this->render("_complaint_view", ["account" => $account, "complaint" => $complaint, "customer" => $customer]) ?>
    </div>
</div>
