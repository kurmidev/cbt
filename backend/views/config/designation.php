...
$this->params['links'] = [
    ['title' => 'Add New Designation', 'url' => \Yii::$app->urlManager->createUrl('config/add-designation'), 'class' => 'fa fa-plus'],
];
...
ImsGridView::widget([
    ...
    'columns' => [
        ...
        'name',
        'code',
        ['attribute' => 'parent_id', 'label' => 'Parent Designation',
        ...
        ['label' => 'Action',
            'content' => function ($data) {
                return Html::a(Html::tag('span', '', ['class' => 'fa fa-edit']), \Yii::$app->urlManager->createUrl(['config/update-designation', 'id' => $data['id']]), ['title' => 'Update ' . $data['name'], 'class' => 'btn btn-primary-alt']);
            }
        ]
    ],
]);
